...
maven_jar(
  name = "com_force_commons_commons_generator",
  artifact = "com.force.commons:commons-generator:0.2.7",
)

maven_jar(
  name = "com_force_commons_commons_text",
  artifact = "com.force.commons:commons-text:0.1.0",
)

maven_jar(
  name = "com_force_commons_commons_util",
  artifact = "com.force.commons:commons-util:0.2.7",
)
...
maven_jar(
  ...
  artifact = "org.apache.zookeeper:zookeeper:3.4.9-client",
)
